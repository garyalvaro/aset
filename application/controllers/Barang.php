...
class Barang extends CI_Controller
{
	...
	{
		$this->load->model('M_data');
		$detail = $this->M_data->detail_barang($id_barang);
		$data['detail'] = $detail;
    ...
    {
        $data['data'] = $this->M_data_pinjam_barang->select_where_join_2('pinjam_barang','pinjam_barang.*,barang.nama_barang as name_barang,user.nama as name_peminjam','pinjam_barang.status','1','barang','pinjam_barang.id_barang','barang.id_barang','user','pinjam_barang.id_user','user.id_user')->result();
		$data['content'] = $this->load->view('barang/barang_users',$data,true);
		$this->load->view('barang/barang_users',$data);
    }
