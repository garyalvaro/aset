...
<body>
	<?php echo form_open('stok/cek_stok');?>
		<input type="text" name="id_barang" id="id_barang" placeholder="id barang" required value=""><br>
		<input type="text" name="tgl_pinjam" id="tgl_pinjam" placeholder="tgl_pinjam" required value=""><br>
		<input type="text" name="tgl_kembali" id="tgl_kembali" placeholder="tgl_kembali" required value=""><br>
		<input type="text" name="qty" id="qty" placeholder="qty" required value=""><br>
		<button id="ini" type="submit">Cek Stok</button>
